...
export const categories = [
  ...
  { id: "chicken-batter", name: "Chicken & Batter", icon: "FaChicken" },
  ...
  { id: "hot-coffee", name: "Hot Coffee", icon: "FaMugHot" },
  { id: "tea", name: "Tea", icon: "FaCoffee" },
  { id: "cold-coffee", name: "Cold Coffee", icon: "FaCoffee" },
  { id: "fresh-juice", name: "Fresh Juice", icon: "FaBlender" },
  ...
  { id: "milkshakes", name: "Milk Shakes", icon: "FaBlender" },
  ...
  { id: "whiskey", name: "Whiskey", icon: "FaWineBottle" },
  { id: "wine", name: "Wine", icon: "FaWineBottle" },
  { id: "prosecco", name: "Prosecco", icon: "FaWineBottle" },
  { id: "champagne", name: "Champagne", icon: "FaWineBottle" },
  { id: "beer", name: "Beer", icon: "FaBeer" },
  { id: "wine-per-glass", name: "Wine per Glass", icon: "FaWineGlass" },
  { id: "shots-shooters", name: "Shots & Shooters", icon: "FaWineGlass" },
  { id: "soft-drinks", name: "Soft Drinks", icon: "FaWineBottle" },
];
